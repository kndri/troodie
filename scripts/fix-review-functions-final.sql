-- Fix review account functions - remove non-existent columns
...
-- Recreate function to get boards with only existing columns
...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE '============================================';
    RAISE NOTICE '✅ Review Account Functions Updated!';
    RAISE NOTICE '============================================';
    RAISE NOTICE '';
    RAISE NOTICE 'Fixed issues:';
    RAISE NOTICE '- Removed non-existent last_activity column';
    RAISE NOTICE '- Corrected all column types to match schema';
    RAISE NOTICE '- Added proper type casting for restaurant_id';
    RAISE NOTICE '';
    RAISE NOTICE 'Review account has % existing boards', board_count;
    RAISE NOTICE '';
